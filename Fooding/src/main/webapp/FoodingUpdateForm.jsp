...
<div class="container">
	<div class="tableBox">
		...
		<table width="400" border="1">
			<form action="FoodingUpdateProc.jsp" method="post">
				<tr height="50">
				...
				<tr height="50">
					...
					<td width="250"><input type="tel" name="tel" value="<%=fb.getTel()%>"></td>
				</tr>
				<tr height="50">
					<td align="center" width="150">이메일</td>
					<td width="250"><input type="email" name="email" value="<%=fb.getEmail()%>"></td>
				</tr>
				<tr height="50">
					<td align="center" width="150">주소</td>
					<td width="250"><input type="text" name="address" value="<%=fb.getAddress()%>"></td>
				</tr>
				<tr height="50">
