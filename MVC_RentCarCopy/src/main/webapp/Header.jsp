		...
		<div class="headerContainerWrap">
			...
			<c:choose>
			  <c:when test="${loginId == null}">
			  	<div class="buttonWrap"><button name="login" onclick="location.href='Main.jsp?sectionChange=MemberLogin.jsp'">로그인</button></div>
			  </c:when>
			  <c:otherwise>
			...
			<div class="navi">
				...
				<div class="menu"><a href="Main.jsp?sectionChange=CarViewReserve.jsp">예약확인</a></div>
